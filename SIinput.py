...
function parseNumberWithUnit(str) {
  ...
  const regex = /^[\s]*([+-]?(?:\d{1,3}(?:[,.]\d{3})*(?:[,.]\d*)?|\d+(?:[,.]\d*)?)(?:[eE][+-]?\d+)?)\s*((?:da)[YZEPTGMkhdμucmnpfazy])?([\p{L}\p{N}_%°²³ΩΩ]+)?[\s]*$/u;
...
//          alert("°F"==="\u00b0F");
    ...
    function render({ model, el }) {
        ...
        let format_spec = formatSpec || model_defaults.format_specs || '.2f';
...
@app.cell
def _():
    s='\u2070\u00b9\u00b2\u00b3'+''.join(chr(0x2074+i)for i in range(8)) 
    mo.md(f"""<span style="font-family:'Courier New'">10<sup>0123456789+-</sup>80.000</span>

    <span style="font-family:''">80.00 10<sup>0123456789+-</sup></span>

    <span style="font-family:'Consolas'">10<sup>0123456789+-</sup></span>

    <span style="font-family:'DejaVu Sans Mono'">10<sup>0123456789+-</sup></span>

    <span style="font-family:'Menlo'">10<sup>0123456789+-</sup></span>

    <span style="font-family: monospace">80.000&#0215;10<sup>0123456789+-</sup></spa n>
